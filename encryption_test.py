...
class Cipher_Generator:
    ...
    def encrypt(self, plaintext, t, add_random_chars = False, num_random_chars = 50):
    ...
    def generate_cipher(self, plaintext, t=5, add_random_chars= False, num_random_chars = 0):
        ...
        # plaintext = test1_plaintexts[ plain_text_number ]
        return self.encrypt(plaintext, t, add_random_chars, num_random_chars)
